...
@pytest.mark.parametrize("filepath", ["notonmymachine.txt", "stereotypicalbmehw.m"])
...
def test_extract_file():
    """ Tests the function "extract_file" from heartRateMonitor.py using a dummy csv file, "dummy.csv"

    :param filepath: the inputted file path
    :returns: True if columns from dummy.csv have been successfully extracted, False otherwise
    """
